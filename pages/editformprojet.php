...
<?php
    ...
    <div id="content" style ="background: #e5a950;">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control"  name="Descriptions" id="Descriptions" value ="<?= $old_Descriptions?>">
        </div>
        <div class="mb-3">
            ...
            <select class="py-2 w-100 bg-gray-200 text-gray-500 rounded-md" name="idcat" id="idcat">
                <option class="text-gray-500"  selected value="<?= $old_idcat?>"><?= $old_idcat?></option>
                <?php
        ...
        <div class="mb-3">
            ...
            <select class="py-2 w-100 bg-gray-200 text-gray-500 rounded-md" name="iduser" id="iduser">
                <option class="text-gray-500"  selected value="<?= $old_iduser?>"><?= $old_iduser?></option>
                <?php
